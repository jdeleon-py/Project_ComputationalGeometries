...
### Simulation Results: Cardioid (mult = 2, 300 points)

![Cardioid (300 Points)](etc/outputs/cardioid.png)

### Simulation Results: Nephroid (mult = 3, 300 points)

![Nephroid (300 Points)](etc/outputs/nephroid.png)

### Simulation Results: Trefoiloid (mult = 4, 300 points)

![Trefoiloid (300 Points)](etc/outputs/trefoiloid.png)

### Simulation Results: Cool Design 1 (mult = 102, 800 points)
